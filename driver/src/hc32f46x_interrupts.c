 ...
 **
 ** \note FreeRTOS 的 SysTick 心跳由 port.o 提供 (FreeRTOSConfig.h 中
 **       #define xPortSysTickHandler SysTick_Handler 把 FreeRTOS 的
 **       xPortSysTickHandler 映射为 SysTick_Handler 强符号, 链接到向量表)。
 **       此处不再重复定义, 否则会与 port.o 的 SysTick_Handler 冲突
 **       (L6200E: Symbol SysTick_Handler multiply defined)。
 ******************************************************************************/
