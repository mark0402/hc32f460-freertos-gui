 ...
 **
 ******************************************************************************/
__RAM_FUNC en_result_t EFM_SingleProgram(uint32_t u32Addr, uint32_t u32Data)
{
 ...
 **
 ******************************************************************************/
__RAM_FUNC en_result_t EFM_SequenceProgram(uint32_t u32Addr, uint32_t u32Len, void *pBuf)
{
    en_result_t enRet = Ok;
    uint8_t u8tmp;
    uint32_t i;
 ...
 **
 ******************************************************************************/
__RAM_FUNC en_result_t EFM_SectorErase(uint32_t u32Addr)
{
    uint8_t u8tmp;
    uint16_t u16Timeout = 0u;
    en_result_t enRet = Ok;
